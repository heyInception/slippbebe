...
function reveal() {
    let reveals = document.querySelectorAll(".product-parallax");
    ...
    for (let i = 0; i < reveals.length; i++) {
        ...
        if (elementTop < windowHeight - elementVisible) {
            reveals[i].classList.add("animate-image-top");
            reveals[i].classList.remove("reverse");
        } else {
            reveals[i].classList.remove("animate-image-top");
